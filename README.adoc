...
<br>
<br>
<p><b>This repository has a containerized basic image classification model sample, exposed as a web app microservice.</b></p>
<br>
...
This repository has a containerized basic image classification model sample, exposed as a web app microservice.
...
This is the Modzy-compatible version of the link:addLinkHere[basic image classification repository].
